<?php get_header(); ?>
	...
	<div id="content">
 	  ...
 	  <?php /* If this is a category archive */ if (is_category()) { ?>
		<h2 class="pagetitle"><?php printf(__('&#8216;%s&#8217; Posts', 'minimalism'), single_cat_title('', false)); ?></h2>
 	  <?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
		<h2 class="pagetitle"><?php printf(__('Posts Tagged &#8216;%s&#8217;', 'minimalism'), single_tag_title('', false) ); ?></h2>
 	  <?php /* If this is a daily archive */ } elseif (is_day()) { ?>
		<h2 class="pagetitle"><?php printf(_c('Post from %s|Daily', 'minimalism'), get_the_time(__('F jS, Y', 'minimalism'))); ?></h2>
 	  <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
		<h2 class="pagetitle"><?php printf(_c('Posts from %s|Monthly', 'minimalism'), get_the_time(__('F, Y', 'minimalism'))); ?></h2>
 	  <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
		<h2 class="pagetitle"><?php printf(_c('Posts from %s|Yearly', 'minimalism'), get_the_time(__('Y', 'minimalism'))); ?></h2>
